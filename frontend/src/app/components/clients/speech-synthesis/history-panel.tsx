...
function HistoryItem({
  item, voices, hoveredItem, setHoveredItem, onPlay
}: {
  ...
  return (
    ...
    >
      <div className="flex flex-col w-full gap-1">
        ...
        {hoveredItem === item.id && (
          <div
            className="absolute right-0 top-0 flex items-center gap-1 bg-gray-100 pl-2"
          >
            <button
              onClick={() => onPlay(item)}
            ...
            <button className="absolute right-0 top-0 flex items-center gap-1">
